        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('updatenewproducts', $userid) }}" class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ $product->sku }}" class="form-control col-md-7 col-xs-12"
                                     name="sku" placeholder=" " required="required" type="text">
                                @if ($errors->has('title'))
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Price<span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ $product->price }}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                    data-validate-words="2" name="price" placeholder=" " required="required" step="0.01" type="number">
                                @if ($errors->has('title'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('title') }}</strong>
                                </span>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Vat<span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ $product->vat }}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                    data-validate-words="2" name="vat" placeholder=" " step="0.01" type="number" required="required">
                                @if ($errors->has('title'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('title') }}</strong>
                                </span>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ $product->stock }}" class="form-control col-md-7 col-xs-12" name="stock" placeholder=" " required="required" type="text">
                                @if ($errors->has('title'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('title') }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12"   >
                                ...
                                <select class="select2_single form-control" tabindex="-1" name="product">
                                    ...
                                    <option {{ $product->productid == $item->id ? 'selected' : ''  }} value="{{ $item->id }}">{{ $item->title }}</option>
                                    @endforeach
                                  </select>
                          ...
                          <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="amount" value="{{ $product->amount }}" name="amount" required="required" class="form-control col-md-7 col-xs-12 amount">
                            ...
                            <div class="item form-group">
                                ...
                                <div id="Only_cheque_div_ID" class="Only_cheque_div" style="display:none;">
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="only_cheque_bank_name">Bank
                                                Name<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="only_cheque_bank_name" name="only_cheque_bank_name" class="form-control col-md-7 col-xs-12"
                                                    data-validate-length-range="6" data-validate-words="2">
                                    ...
                                    <div id="both_div_id" class="both_Div" style="display:none;">
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="cash_amount" name="cash_amount" class="form-control col-md-7 col-xs-12 both_amount">
                                            ...
                                            <div class="item form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="both_cheque_bank_name">Bank
                                                    Name<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select id="both_cheque_bank_name" name="both_cheque_bank_name" class="form-control col-md-7 col-xs-12"
                                                        data-validate-length-range="6" data-validate-words="2">
                                                        @foreach ($bank as $item)
                                                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                                                        @endforeach
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="datepicker" autocomplete="off" type="text" value="{{ $product->created_at }}"  name="date"
