        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" novalidate action="{{ route('newproducts') }}" class="form-horizontal form-label-left">
                        @csrf
                        <span class="section">Insert Additional Products</span>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ old('sku') }}" class="form-control col-md-7 col-xs-12"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ old('price') }}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ old('vat') }}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" value="{{ old('stock') }}" class="form-control col-md-7 col-xs-12" name="stock" placeholder=" " required="required" type="text">
                                @if ($errors->has('stock'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="amount" name="amount" required="required" class="form-control col-md-7 col-xs-12 amount">
