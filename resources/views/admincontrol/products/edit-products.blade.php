        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('updateproduct', $userid) }}" class="form-horizontal form-label-left">
                        @csrf
                        <span class="section">Update Products</span>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                    data-validate-words="2" value="{{ $product->title }}" name="title" placeholder=" "
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea maxlength="100" id="name" rows="4" class="form-control col-md-7 col-xs-12"
                                    ...
                                    placeholder=" " required="required">{{ $product->description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select class="select2_single form-control" tabindex="-1" name="units">
                                    ...
                                    <option {{ $product->unitid == $item->id ? 'selected' : ''  }} value="{{ $item->id }}">{{
                                        $item->name }}</option>
                                    @endforeach
                                </select>
