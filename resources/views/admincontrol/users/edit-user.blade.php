        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('updateuser',$user->id) }}" class="form-horizontal form-label-left">
                        @csrf
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                    data-validate-words="2" name="name" value="{{ $user->name }}" required="required"
                                    type="text">
                                @if ($errors->has('name'))
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="{{ $user->email }}" type="email" id="email" name="email" required="required"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="{{ $user->contract }}" type="text" id="contract" name="contract" required="required"
                                    class="form-control col-md-7 col-xs-12">
