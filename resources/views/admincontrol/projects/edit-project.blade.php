        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('updateprojects',$prjctedit->id) }}" class="form-horizontal form-label-left">
                        @csrf
                        <span class="section">Update Project</span>
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pname">Project Name<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="{{ $prjctedit->project_name }}" id="pname" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="creBy" id="creBy" required="required" class="form-control col-md-7 col-xs-12">
                                    @foreach ($customerId as  $item)
                                     <option {{ $prjctedit->customerid == $item->id ?'selected':'' }} value="{{ $item->id }}">{{ $item->contact_person }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('creBy'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="datepicker" autocomplete="off" type="text" value="{{ $prjctedit->date }}"  name="date"
