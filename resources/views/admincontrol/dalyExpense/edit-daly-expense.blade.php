        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('updateexpense',$dalyExpense->id) }}" class="form-horizontal form-label-left">
                        @csrf
                        <span class="section">Create Dlay Expense</span>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select id="project_name" name="project_name" class="form-control col-md-7 col-xs-12"
                                    ...
                                    <option {{ $dalyExpense->projectid == $item->id ?'selected':'No Project' }} value="{{ $item->id }}">{{
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="{{ $dalyExpense->title }}" type="text" id="title" name="title" required="required"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea required="required" name="description" id="description" cols="10" rows="5"
                                    class="form-control col-md-7 col-xs-12">{{  $dalyExpense->description }} </textarea>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="{{ $dalyExpense->amount }}" type="text" id="amount" name="amount"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select id="payment_method" name="payment_method" required="required" class="form-control col-md-7 col-xs-12 paymethod"
                                    data-validate-length-range="6" data-validate-words="2">
                                    <option {{ $dalyExpense->payment_method == 1 ?'selected':'' }} value="1">Cash</option>
                                    <option {{ $dalyExpense->payment_method == 2 ? 'selected':'' }} value="2">Cheque</option>
                                    <option {{ $dalyExpense->payment_method == 3 ? 'selected':'' }} value="3">Both</option>
                                </select>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="only_cheque_bank_name" name="only_cheque_bank_name" class="form-control col-md-7 col-xs-12"
                                        ...
                                        <option {{ $dalyExpense->bank_id == $item->id ?'selected':'' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div id="both_div_id" class="both_Div" style="display:none;">
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input value="{{ $dalyExpense->cash }}" type="text" id="cash_amount" name="cash_amount" class="form-control col-md-7 col-xs-12 both_amount">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input value="{{ $dalyExpense->bank_amount }}" type="text" id="both_cheque_amount" name="both_cheque_amount" class="form-control col-md-7 col-xs-12 both_amount">
                        ...
                        <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="datepicker" autocomplete="off" type="text" value="{{ $dalyExpense->date }}"  name="date"
                                        class="form-control col-md-7 col-xs-12">
                                    @if ($errors->has('date'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <a href="{{ route('viewexpense') }}" class="btn btn-primary">Back</a>
                                <input id="submit" class="btn btn-info" type="submit" value="Update" />
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        var selectid = $('#payment_method :selected').val();
        if (selectid == 2) {
