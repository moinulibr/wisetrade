                ...
                <td>
                    @if(Auth::user()->type == 2)
                        @if ($item->status == 0)
                                ...
                                <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#unfrozen-{{ $item->id }}"><i
                                    class="fa fa-trash-o"></i> 
                                Active
                                </button>
                            @else 
                                <button type="button" class="btn btn-dark btn-xs" data-toggle="modal" data-target="#frozen-{{ $item->id }}"><i
                                        class="fa fa-trash-o"></i>
                                    Fridge
                                </button>
                            <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#unfrozen-{{ $item->id }}"><i
                                class="fa fa-trash-o"></i> 
                            Active
                            </button>
                        @endif   
                    ...
                    @elseif(Auth::user()->type == 1 && $item->verified == 0)
                        <a href="{{ route('editbankdeposit',$item->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                            Edit </a>
                   ...
                   <div class="modal-dialog">
                       ...
                       <div class="modal-content">
                           ...
                           <div class="modal-footer">
                               ...
                               <a href="{{ route('unfrozenbankdeposit',$item->id??0) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i>
                                  Active </a>
                               </div>
                       </div>
                   </div>
            ...
            <div id="frozen-{{ $item->id }}" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>
                            <a href="{{ route('frozenbankdeposit',$item->id??0) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i>
                               Fridge </a>
                            </div>
                    </div>
                </div>
            ...
            <div id="myModal-{{ $item->id }}" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>
                            <a href="{{ route('deletebankdeposit',$item->id??0) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i>
                                Delete </a>
                            </div>
                    </div>
                </div>
