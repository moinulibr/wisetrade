        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" novalidate action="{{ route('updateexpenses',$dalyExpense->id) }}" class="form-horizontal form-label-left" >
                        @csrf
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="{{ $dalyExpense->title }}" type="text" id="title" name="title" required="required" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('title'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input value="{{ $dalyExpense->amount }}" type="text" id="amount" name="amount" required="required" class="form-control col-md-7 col-xs-12 amount">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <a href="{{ route('viewexpenses') }}" class="btn btn-primary">Back</a>
